...
extension HAcceptVideoVC {
    ...
    @objc func tupleExa2_sizeForItemAtIndexPath(_ indexPath: IndexPath) -> Any {
        switch (indexPath.row) {
            ...
            case 1: return CGSizeMake(self.tupleView.width, KAcceptVideoHeight1*1.5);
            case 2: return CGSizeMake(self.tupleView.width, KAcceptVideoHeight1);
            case 3: return CGSizeMake(self.tupleView.width, UIScreen.height-UIScreen.naviBarHeight-65-KAcceptVideoHeight1*1.5-KAcceptVideoHeight1-(KAcceptVideoHeight1+25)-40-(KAcceptVideoHeight2+25)-30);
    ...
    @objc func tupleExa2_tupleItem(_ itemBlock: Any, atIndexPath indexPath: IndexPath) {
        ...
        switch (indexPath.row) {
            ...
            case 1:
                ...
                let frame1 = CGRectMake(bounds.size.width-20-KAcceptVideoHeight1, 0, KAcceptVideoHeight1, KAcceptVideoHeight1*1.5)
            ...
            case 2:
                ...
                let frame1 = CGRectMake(bounds.size.width/2-KAcceptVideoHeight1/2, 0, KAcceptVideoHeight1, KAcceptVideoHeight1)
                cell.buttonView.frame = frame1
                ...
                let frame2 = CGRectMake(bounds.size.width/2-KAcceptVideoHeight1/2, KAcceptVideoHeight1, KAcceptVideoHeight1, 25)
            ...
            case 6:
                ...
                let frame1 = CGRectMake(40, 5, KAcceptVideoHeight1, KAcceptVideoHeight1)
                cell.buttonView.frame = frame1
                cell.buttonView.setImageWithName("mdeia-button")
                cell.buttonView.pressed = { (_ sender: Any?, _ data: Any?) in
                ...
                let frame2 = CGRectMake(40, KAcceptVideoHeight1+5, KAcceptVideoHeight1, 25)
                cell.label.frame = frame2
                cell.label.text = "翻转"
                cell.label.textColor =  UIColor.white
                cell.label.font  = UIFont.systemFont(ofSize: 12)
                ...
                let frame3 = CGRectMake(bounds.size.width/2-KAcceptVideoHeight2/2, 0, KAcceptVideoHeight2, KAcceptVideoHeight2)
                cell.detailButtonView.frame = frame3
                cell.detailButtonView.setImageWithName("mdeia-button")
                cell.detailButtonView.pressed = { (_ sender: Any?, _ data: Any?) in
                ...
                let frame4 = CGRectMake(bounds.size.width/2-KAcceptVideoHeight2/2, KAcceptVideoHeight2, KAcceptVideoHeight2, 25)
                cell.detailLabel.frame = frame4
                ...
                let frame5 = CGRectMake(bounds.size.width-40-KAcceptVideoHeight1, 5, KAcceptVideoHeight1, KAcceptVideoHeight1)
                ...
                let frame6 = CGRectMake(bounds.size.width-38-KAcceptVideoHeight1, KAcceptVideoHeight1+5, KAcceptVideoHeight1, 25)
