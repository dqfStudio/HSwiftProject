...
extension HSendVideoVC {
    @objc func tupleExa4_numberOfItemsInSection(_ section: Any) -> Any {
        return 8
    }
    @objc func tupleExa4_sizeForItemAtIndexPath(_ indexPath: IndexPath) -> Any {
    ...
    @objc func tupleExa4_tupleItem(_ itemBlock: Any, atIndexPath indexPath: IndexPath) {
