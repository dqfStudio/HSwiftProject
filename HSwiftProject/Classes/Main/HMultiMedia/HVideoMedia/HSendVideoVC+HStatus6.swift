...
extension HSendVideoVC {
    @objc func tupleExa5_numberOfItemsInSection(_ section: Any) -> Any {
        return 8
    }
    @objc func tupleExa5_sizeForItemAtIndexPath(_ indexPath: IndexPath) -> Any {
    ...
    @objc func tupleExa5_tupleItem(_ itemBlock: Any, atIndexPath indexPath: IndexPath) {
