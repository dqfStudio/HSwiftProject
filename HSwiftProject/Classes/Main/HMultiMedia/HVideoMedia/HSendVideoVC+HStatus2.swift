...
extension HSendVideoVC {
    ...
    @objc func tupleExa1_sizeForItemAtIndexPath(_ indexPath: IndexPath) -> Any {
        switch (indexPath.row) {
            ...
            case 1: return CGSizeMake(self.tupleView.width, UIScreen.height-UIScreen.naviBarHeight-65-30-70-(KSendVideoHeight1+25)-40-(KSendVideoHeight2+25)-30);
    ...
    @objc func tupleExa1_tupleItem(_ itemBlock: Any, atIndexPath indexPath: IndexPath) {
        ...
        switch (indexPath.row) {
            ...
            case 6:
                ...
                let frame1 = CGRectMake(bounds.size.width/2-KSendVideoHeight2/2, 0, KSendVideoHeight2, KSendVideoHeight2)
                cell.buttonView.frame = frame1
                cell.buttonView.setImageWithName("mdeia-button")
                cell.buttonView.pressed = { (_ sender: Any?, _ data: Any?) in
                ...
                let frame2 = CGRectMake(bounds.size.width/2-KSendVideoHeight2/2, KSendVideoHeight2, KSendVideoHeight2, 25)
                cell.label.frame = frame2
                cell.label.text = "挂断"
                cell.label.textColor =  UIColor.white
                cell.label.font  = UIFont.systemFont(ofSize: 12)
