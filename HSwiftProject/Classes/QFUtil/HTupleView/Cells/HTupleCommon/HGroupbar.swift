...
class HGroupbar: UIStackView, HTupleViewDelegate {
    ...
    var indicatorBarWidth: CGFloat {
        ...
        set {
            if _indicatorBarWidth != newValue {
                ...
                let frame = CGRect(x: 0.0, y: self.height - indicatorBarHeight, width: _indicatorBarWidth, height: indicatorBarHeight)
    ...
    var selectedBlock: HGroupbarBlock?
