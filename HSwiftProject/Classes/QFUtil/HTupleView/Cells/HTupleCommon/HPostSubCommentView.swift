...
class HPostSubCommentView: UIStackView, HTupleViewDelegate {
...
extension HPostSubCommentView {
    ...
    func tupleExa0_tupleItem(_ itemBlock: Any, atIndexPath indexPath: IndexPath) {
        ...
        var headerView = cell.layoutView.viewWithTag(121314) as? HPostSubCommentHeader
        if headerView == nil {
            headerView = HPostSubCommentHeader(frame: frame)
