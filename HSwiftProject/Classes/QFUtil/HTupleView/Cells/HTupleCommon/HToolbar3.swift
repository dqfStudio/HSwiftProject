...
//  HSwiftProject
//
//  Created by owner on 2023/5/17.
//  Copyright © 2023 wind. All rights reserved.
//

import UIKit

class HToolbar3: UIStackView, HTupleViewDelegate {
...
//    }
    ...
    func tupleFooter(_ footerBlock: Any, inSection section: Any) {
        ...
        _ = footerBlock(nil, HTupleBaseApex.self, nil, true) as! HTupleBaseApex
    }
...
//        if self.indicatorBar.x >= 0 || self.indicatorBar.x <= self.indicatorBar.width * 2 {
