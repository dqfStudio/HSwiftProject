...
class HCollRowApexChrome: HCollStackApex {
...
/// 文案从左抱紧，中间没有弹性空位。
class HCollPackedRowApex: HCollRowApexChrome {
...
/// 标题在左，详情/附加靠右。
class HCollValueRowApex: HCollRowApexChrome {
...
/// 中间标题 / 副标题 / 附加竖着叠。
class HCollSubtitleRowApex: HCollRowApexChrome {
