...
///三个label横向从左向右抱紧显示
class HTupleViewCellHoriValue1: HTupleTmplCell {
    ...
    override func relayoutSubviews() {
        ...
        if let imageView = _imageView {
            ...
            updateTupleConstraint(&imageWidthConstraint, on: imageView, attr: .width, constant: imageFrame.width)
            updateTupleConstraint(&imageHeightConstraint, on: imageView, attr: .height, constant: imageFrame.height)
        ...
        updateTupleConstraint(&labelWidthConstraint, on: label, attr: .width, constant: actualLabelWidth)
        if !didSetupLayout {
        ...
        if let accsryLabel = _accsryLabel {
            ...
            updateTupleConstraint(&detailLabelWidthConstraint, on: detailLabel, attr: .width, constant: actualDetailWidth)
            if !didSetupLayout {
        ...
        if let detailView = _detailView {
            ...
            updateTupleConstraint(&detailWidthConstraint, on: detailView, attr: .width, constant: detailFrame.width)
            updateTupleConstraint(&detailHeightConstraint, on: detailView, attr: .height, constant: detailFrame.height)
        ...
        if isShowAccsryArrow {
            ...
            updateTupleConstraint(&accsryWidthConstraint, on: accsryView, attr: .width, constant: 7)
            updateTupleConstraint(&accsryHeightConstraint, on: accsryView, attr: .height, constant: 13)
        }
...
///三个label横向从右向左抱紧显示
class HTupleViewCellHoriValue2: HTupleTmplCell {
    ...
    override func relayoutSubviews() {
        ...
        if let detailLabel = _detailLabel {
            if detailWidth > 0 {
                updateTupleConstraint(&detailLabelWidthConstraint, on: detailLabel, attr: .width, constant: detailWidth)
            }
            if !didSetupLayout {
                textLayoutView.addArrangedSubview(detailLabel)
            }
        ...
        if let accsryLabel = _accsryLabel {
            if accsryWidth > 0 {
                updateTupleConstraint(&accsryLabelWidthConstraint, on: accsryLabel, attr: .width, constant: accsryWidth)
            }
            if !didSetupLayout {
                textLayoutView.addArrangedSubview(accsryLabel)
            }
...
///三个label纵向显示
class HTupleViewCellHoriValue3: HTupleTmplCell {
...
private func updateTupleConstraint(_ constraint: inout NSLayoutConstraint?, on view: UIView, attr: NSLayoutConstraint.Attribute, constant: CGFloat) {
