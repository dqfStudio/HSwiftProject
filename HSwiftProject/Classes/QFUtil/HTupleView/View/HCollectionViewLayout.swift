...
private var HCollectionViewSectionColor = "com.dqf.HCollElementKindSectionColor"
...
@objc protocol HCollectionViewLayoutDelegate: UICollectionViewDelegateFlowLayout {
...
class HCollectionViewLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        guard let delegate = collectionView.delegate as? HCollectionViewLayoutDelegate else { return }

        // 1. Initialization
        self.register(HCollReusableView.self, forDecorationViewOfKind: HCollectionViewSectionColor)
