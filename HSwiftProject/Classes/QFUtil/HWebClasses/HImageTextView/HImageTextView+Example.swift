...
extension HImageTextView {
    ...
    /// 创建一个默认的图文组合视图
    static func createDefaultCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 200, height: 100))
        view.text = "示例文本"
    ...
    /// 创建一个带网络图片的图文组合视图
    static func createNetworkImageCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 200, height: 100))
        view.text = "网络图片示例"
        view.textColor = .black
        view.imageSize = CGSize(width: 44, height: 44)
    ...
    /// 创建一个带背景图片的图文组合视图
    static func createBackgroundImageCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 200, height: 100))
        view.text = "背景图片示例"
    ...
    static func createImageTopCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 100, height: 120))
        view.text = "图片在上"
        view.textColor = .black
    ...
    static func createImageBottomCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 100, height: 120))
        view.text = "图片在下"
        view.textColor = .black
        view.textFont = .systemFont(ofSize: 14)
    ...
    static func createImageRightCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 200, height: 100))
        view.text = "图片在右"
        view.textColor = .black
        view.textFont = .systemFont(ofSize: 16)
    ...
    /// 创建一个带点击事件的图文组合视图
    static func createClickableCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 200, height: 100))
        view.text = "点击我"
        view.textColor = .black
        view.textFont = .systemFont(ofSize: 16)
    ...
    /// 使用链式调用创建图文组合视图
    static func createCompositeViewWithChainSyntax() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 200, height: 100))
            .text("链式调用示例")
            .textColor(.black)
    ...
    /// 创建带状态管理的图文组合视图
    static func createStatefulCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 200, height: 100))
            .text("状态管理示例")
            .textColor(.black)
            .imageSize(CGSize(width: 44, height: 44))
        ...
        // 点击事件：默认不切换 selected。需要开关行为时设 togglesSelectionOnTap = true
        view.pressed = { sender, data in
            guard let compositeView = sender as? HImageTextView else { return }
    ...
    /// 创建带手势支持的图文组合视图
    static func createGestureCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 200, height: 100))
            .text("手势支持示例")
            .textColor(.black)
            .imageSize(CGSize(width: 44, height: 44))
    ...
    /// 创建带可访问性设置的图文组合视图
    static func createAccessibleCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 200, height: 100))
            .text("可访问性示例")
            .textColor(.black)
            .imageSize(CGSize(width: 44, height: 44))
    ...
    /// 创建带滑动和拖拽手势的图文组合视图
    static func createGestureAdvancedCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 200, height: 100))
            .text("手势高级示例")
            .textColor(.black)
            .imageSize(CGSize(width: 44, height: 44))
    ...
    /// 创建图片居中布局的图文组合视图
    static func createImageCenterCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 150, height: 150))
            .text("图片居中")
            .textColor(.black)
    ...
    /// 创建文字环绕布局的图文组合视图
    static func createTextWrapCompositeView() -> HImageTextView {
    ...
    /// 创建带渐变背景的图文组合视图
    static func createGradientBackgroundCompositeView() -> HImageTextView {
        let view = HImageTextView(frame: CGRect(x: 0, y: 0, width: 200, height: 100))
            .text("渐变背景")
            .textColor(.white)
            .textFont(.systemFont(ofSize: 16))
        ...
        // 设置渐变背景
        view.gradientBackgroundColors = [UIColor.blue, UIColor.purple]
