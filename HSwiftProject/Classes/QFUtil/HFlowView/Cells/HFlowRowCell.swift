...
class HFlowRowChrome: HFlowStackCell {
    ...
    /// 对应 HCollRowCell.imageView。UITableViewCell 已占用 `imageView`，故用此名，避免系统布局读到 getter 副作用。
...
/// 文案从左抱紧，中间没有弹性空位。
class HFlowPackedRowCell: HFlowRowChrome {
...
/// 标题在左，详情/附加靠右。
class HFlowValueRowCell: HFlowRowChrome {
...
/// 中间标题 / 副标题 / 附加竖着叠。
class HFlowSubtitleRowCell: HFlowRowChrome {
