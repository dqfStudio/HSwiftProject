...
///三个label横向从左向右抱紧显示
class HFlowViewCellHoriValue1: HFlowBaseCell {
...
///三个label横向从右向左抱紧显示
class HFlowViewCellHoriValue2: HFlowBaseCell {
...
///三个label纵向显示
class HFlowViewCellHoriValue3: HFlowBaseCell {
